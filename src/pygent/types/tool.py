...
def _required_factory() -> list[str]:
    return []


def _parameters_factory() -> dict[str, Any]:
    return {}
...
class JsonSchema(BaseModel):
    ...
    required: list[str] = Field(default_factory=_required_factory)
...
class ToolDefinition(BaseModel):
    ...
    name: str
    description: str
    parameters: dict[str, Any] = Field(default_factory=_parameters_factory)
    ...
    def validate_arguments(self, arguments: dict[str, Any]) -> None:
        ...
        schema = JsonSchema.model_validate(self.parameters)
...
def _validate_value(
    ...
    """Validate a single tool argument against a JSON Schema property."""
